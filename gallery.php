...
<div class="pure-g">
  <div class="pure-u-1"><h2>Things I've Made</h2></div>
    ...
    <div id="videography" class="interest-selection pure-u-sm-1 pure-u-md-1-2 pure-u-lg-1-5">
      <a class="block-link" id="videography" href="#"><i class="fa interest-icon fa-video-camera"></i><br>Videography</a></div>
    <div id="web" class="interest-selection pure-u-sm-1 pure-u-md-1-2 pure-u-lg-1-5">
      <a class="block-link" id="web" href="#"><i class="fa interest-icon fa-code"></i><br>Web Development</a></div>
    <div id="print" class="interest-selection pure-u-sm-1 pure-u-md-1-2 pure-u-lg-1-5">
      <a class="block-link" id="print" href="#"><i class="fa interest-icon fa-pencil"></i><br>Print graphics</a></div>
    <div id="other" class="interest-selection pure-u-sm-1 pure-u-md-1-2 pure-u-lg-1-5">
      <a class="block-link" id="other" href="#"><i class="fa interest-icon fa-ellipsis-h"></i><br>Other</a></div>
  ...
  <div class="interest-display pure-u-1" id="gallery">
    ...
    <a class="fancybox" data-caption="This is the caption" title="Captionnn" rel="lightbox" href="imgs/gallery/fullsize1.jpg"><img class="gallery-thumbnail all web" src="imgs/gallery/thumb1.jpg" alt="Kittens are cute" /></a>
    <a class="fancybox" data-caption="This is the caption" title="Captionnn" rel="lightbox" href="imgs/gallery/fullsize1.jpg"><img class="gallery-thumbnail all videography" src="imgs/gallery/thumb1.jpg" alt="Kittens are cute" /></a>
    <a class="fancybox" data-caption="This is the caption" title="Captionnn" rel="lightbox" href="imgs/gallery/fullsize1.jpg"><img class="gallery-thumbnail all print" src="imgs/gallery/thumb1.jpg" alt="Kittens are cute" /></a>
